...
function showShare(uid,mid,similar,sex){
  ...
  changeHref("#flash_ren",mid,similar,0);
  changeHref("#share_sina",mid,similar,1);
  changeHref("#share_qq",mid,similar,1);
  changeHref("#share_ren",mid,similar,1);
...
function changeHref(selector,mid,similar,type){
  ...
  if(type==0){
    ...
    str="&pic=http://client.17bi.net/luxgen/img.php";
  }
  if(mid){
    if(similar){
      href=href.replace(str,"&pic=http://client.17bi.net/luxgen/img.php?mid="+mid+"&similar="+similar);
    }else{
      href=href.replace(str,"&pic=http://client.17bi.net/luxgen/img.php?mid="+mid);
    }
  }else{
    href=href.replace(str,"&pic=http://client.17bi.net/luxgen/img.php");
  }
...
function renderHeight(){
  ...
  if($width<1024){
    $width=1024;
    $(".nav_main").css({"width":$width*0.58,"left":"200px"});
    $(".nav_sub").css({"width":$width*0.20, "right":0});
  }
