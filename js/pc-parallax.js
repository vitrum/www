...
function changeHref(selector,mid,similar,type){
  ...
  if(type>=3){
    /*if(mid){
      ...
      pic="http%3a%2f%2fclient.17bi.net%2fluxgen%2fimg.php%3fmid%3d%26similar%3d";
    }*/
    $.ajax({
    type:"POST",
    url:"img-pc.php?mid=28&similar=80",
    data: {},
...
function pageTransition(){
  ...
  if(hash=="hand"){
    $(".subPanel").fadeOut(0);
    $("."+subPanel).fadeIn(0);
    $('.body').animate({scrollTop: 800}, 400, function() {});
  }
  if(hash=="pro"){
    $('.body').animate({scrollTop: 1600}, 400, function() {});
  }
  if(hash=="win"){
    $(".subPanel").fadeOut(0);
    $("."+subPanel).fadeIn(0);
    $('.body').animate({scrollTop: 2400}, 400, function() {});
  }
  if(hash=="intro"){
    $(".body").css({"height":"1200px"});
    $(".panel").css({"height":"1200px"});
    $('.body').animate({scrollTop: 3200}, 400, function() {});
  }
...
function parallaxScroll(){
  ...
  $('#parallax-bg4').css('top',(0-(scrolled*.85))+'px');
  $('#parallax-bg5').css('top',(0-(scrolled*.65))+'px');
}
...
function redrawDotNav(){
  ...
  var section2Top =  $('.p_home').offset().top - (($('.p_hand').offset().top - $('.p_hand').offset().top) / 2);
  var section3Top =  $('.p_hand').offset().top - (($('.p_pro').offset().top - $('.p_win').offset().top) / 2);
  var section4Top =  $('.p_win').offset().top - (($(document).height() - $('.p_win').offset().top) / 2);;
